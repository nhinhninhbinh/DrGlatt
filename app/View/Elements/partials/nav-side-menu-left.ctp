        ...
        <div class="menu-list">
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="products">
                  ...
                  <li class="sub-title-menu"><a href="/review">Review sản phẩm</a></li>
                  <li class="sub-title-menu"><a href="/faq">Hỏi đáp</a></li>
                  <li class="sub-title-menu"><a href="/news">Tin tức</a></li>
                </ul>
                ...
                <li>
                  <a href="/beauty-corner" class="title-menu" ></i> Góc làm đẹp</a>
                </li>

                <li>
                  <a href="/buy" class="title-menu"></i> Mua hàng</a>
                </li>
            </ul>
     </div>
</div>